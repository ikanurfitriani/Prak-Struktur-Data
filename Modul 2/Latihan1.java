...
{	public static int N=5;
	...
	public static void main(String[] args)
	{
		...
		System.out.print("Masukkan data yang ingin diinputkan (Maks 15): ");
		N = input.nextInt();
		if(N>0 && N<=15) {
			//bagian deklarasi record berbasis LARIK ----------------------------------------
			formatBiodata3 biodataMahasiswa[] = new formatBiodata3[N];
			for (int i=0; i<N; i++)
			biodataMahasiswa[i] = new formatBiodata3();
			ngentriData(biodataMahasiswa);
			tampilkanData(biodataMahasiswa);
		} else {
			System.out.println("Salah masukan data (Maks. 15)");
		}
	}
}